                                ...
                                <tbody>
                                    @forelse ($presensis as $presensi)
                                        <tr>
                                            ...
                                            <td><a href="/presensi/pengajuan-konfirmasi/rekap-presensi/{{ $presensi->pertemuan }}/{{$presensi->matkul_id}}/{{$presensi->kelas_id}}/{{ $presensi->jadwals_id }}" class="btn btn-warning btn-sm"><span class="mdi mdi-eye"></span> Lihat</a></td>
                                        </tr>
                                    @empty
                                        <tr>
