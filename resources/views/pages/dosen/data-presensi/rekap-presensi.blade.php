...
<head>
    ...
    <title>Ganjil | {{ $absens->first()->kelas->nama_kelas }} | Semester {{ $absens->first()->matkul->nama_matkul }}</title>
    <style>
        body {
        ...
        .header-info h5 {
            font-size: 10px; /* Ukuran font di header info */
            margin: 0; /* Hapus margin untuk konsistensi */
        }
    ...
    <div style="text-align: left;">
        ...
        <div class="signature-section">
            ...
            <div class="signature-box right">
                ...
                <h5 style="margin-left: 100px;margin-bottom:">.....................................................</h5>
