        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-center mb-4">EDIT NILAI UAS MAHASISWA</h5>
                            <div class="row mb-4">
                                <div class="col-md-5 col-12">
                                    <ul class="list-unstyled">
                                        <li class="d-flex align-items-center">
                                            ...
                                            <span>{{ $uas->first()->matkul->nama_matkul }}</span>
                                        </li>
                                        <li class="d-flex align-items-center mt-2">
                                            <span style="width: 140px;">Dosen</span>
                                            <span style="margin-right: 5px;">:</span>
                                            <span>{{ $uas->first()->jadwal->dosen->nama }}</span>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-md-5 offset-md-2 col-12">
                                    <ul class="list-unstyled">
                                        <li class="d-flex align-items-center">
                                            ...
                                            <span style="margin-right: 5px;">:</span>
                                            <span>{{ $uas->first()->kelas->prodi->nama_prodi }}</span>
                                        </li>
                                        <li class="d-flex align-items-center mt-2">
                                            <span style="width: 140px;">Kelas</span>
                                            <span style="margin-right: 5px;">:</span>
                                            <span>{{ $uas->first()->kelas->nama_kelas }}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <form method="POST"
                                    action="{{ url('/presensi/data-nilai/' . $kelas_id . '/' . $matkul_id . '/' . $jadwal_id . '/uas') }}">
                                    @csrf
                                    @method('PUT')
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <input type="number" name="nilai[]" id="nilai_{{ $mahasiswa->id }}"
                                                    value="{{ $uas->where('mahasiswa_id', $mahasiswa->id)->first()->nilai ?? '' }}"
