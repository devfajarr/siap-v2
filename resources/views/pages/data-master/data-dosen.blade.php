                    ...
                    <div class="card">
                        <div class="card-header bg-white">
                            <div class="p-2">
                                ...
                                <a href="{{ route('dosen.export') }}" class="btn btn-primary btn-sm">
                ...
                <div class="modal-body">
                    <form id="tambahForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    <label for="nidn" class="form-label">NUPTK</label>
    ...
    <div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
 			...
 			<div class="mb-3">
                            <a href="{{ route('download.format.dosen') }}" class="btn btn-sm btn-outline-primary w-100">
