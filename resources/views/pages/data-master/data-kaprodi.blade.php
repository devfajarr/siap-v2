                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-primary btn-sm editKaprodi"
                                                        data-id="{{ $kaprodi->id }}" 
                                                        data-dosens-id="{{ $kaprodi->dosens_id }}"
                                                        data-id="{{ $kaprodi->id }}"
                ...
                <div class="modal-body">
                    <form id="tambahForm">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="id" name="nama">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.editKaprodi').on('click', function() {
                ...
                const dosens_id = $(this).data('dosensId');
                const prodi = $(this).data('prodi');
                const status = $(this).data('status');


                $('#edit_id').val(id);
                $('#idEdit').val(dosens_id);
                    ...
                    error: function(response) {
                        if (response.status === 422) {
                            ...
                            if (errors.dosens_id) {
                                ...
                                $('#editDosenError').text(errors.dosens_id[0]);
                            }
                            if (errors.prodis_id) {
