  ...
  <AdminLayout>
    ...
    <div class="space-y-6">
      <div class="flex items-center gap-2">
        <Link 
          :href="route('v2.kaprodi.monitoring.perkuliahan.index')"
        ...
        <div>
          ...
          <p class="text-[#6B7280] text-sm">Monitoring kehadiran mahasiswa per mata kuliah.</p>
        </div>
      </div>

      <Card class="border-none shadow-sm">
        <CardHeader>
          <CardTitle class="text-lg">Daftar Mata Kuliah & Jadwal</CardTitle>
        </CardHeader>
                ...
                <TableRow v-for="jadwal in jadwals" :key="jadwal.id">
                  ...
                  <TableCell class="text-center">
                    <div class="flex items-center justify-center gap-2">
                      <Link 
                        :href="route('v2.kaprodi.monitoring.perkuliahan.presensi-cek', {
                      ...
                      >
                        <Button variant="outline" size="sm" class="h-8 text-xs bg-blue-50 text-blue-600 border-blue-200 hover:bg-blue-100">
                          P 1-7
                        </Button>
                      </Link>
                      <Link 
                      ...
                      >
                        <Button variant="outline" size="sm" class="h-8 text-xs bg-indigo-50 text-indigo-600 border-indigo-200 hover:bg-indigo-100">
                          P 8-14
                        </Button>
                      </Link>
                      <Button 
