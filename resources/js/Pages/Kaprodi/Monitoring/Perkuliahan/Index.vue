...
import { School, ArrowRight, Search, BookOpen, Grid, AlertCircle } from 'lucide-vue-next'
  ...
  <AdminLayout>
    ...
    <div class="space-y-8">
      ...
      <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 class="text-3xl font-extrabold text-[#1F2937] tracking-tight">Monitoring Perkuliahan</h1>
          <p class="text-[#6B7280] text-sm mt-1">Pilih kelas untuk melihat detail jadwal, kehadiran perkuliahan, dan diskusi akademik.</p>
        </div>
      </div>
          ...
          <Card class="border border-slate-100 hover:border-[#4B49AC]/20 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 rounded-2xl overflow-hidden bg-white">
            <CardHeader class="pb-3 border-b border-slate-50 bg-[#4B49AC]/[0.02] p-6">
              <div class="flex items-center justify-between">
                <div class="p-2.5 bg-white border border-[#4B49AC]/10 rounded-xl group-hover:scale-110 transition-transform duration-300 shadow-sm">
            ...
            <CardContent class="pt-4 pb-5 px-6">
              <div class="flex items-center justify-between text-xs font-bold text-[#4B49AC] transition-colors">
                <span class="tracking-wider text-slate-400 group-hover:text-[#4B49AC] transition-colors">LIHAT DETAIL JADWAL</span>
