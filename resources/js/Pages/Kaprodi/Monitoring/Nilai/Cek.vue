    ...
    <div class="space-y-6 max-w-7xl mx-auto pb-12 font-sans">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 print:hidden">
        <div class="flex items-center gap-2">
          <Link
            :href="route('v2.kaprodi.monitoring.nilai.detail', kelas.id)"
            class="p-1.5 hover:bg-gray-100 rounded-full transition-colors"
          >
            <ChevronLeft class="w-6 h-6 text-gray-500" />
          </Link>
          <div>
            <h1 class="text-2xl font-bold text-[#1F2937] tracking-tight">Cek Rekap Nilai</h1>
        ...
        <div class="flex items-center gap-2 self-end sm:self-auto">
          <Button
            @click="printPage"
            class="bg-[#4B49AC] hover:bg-[#3f3da3] text-white flex items-center gap-1.5 rounded-lg shadow-sm"
          >
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 print:hidden">
        <Card class="border-none shadow-sm bg-white rounded-lg">
          <CardContent class="p-4 flex items-center gap-4">
            ...
            <div>
              <p class="text-xs text-gray-400 uppercase font-bold tracking-wider">Total Mahasiswa</p>
        ...
        <Card class="border-none shadow-sm bg-white rounded-lg">
          <CardContent class="p-4 flex items-center gap-4">
            ...
            <div>
              <p class="text-xs text-gray-400 uppercase font-bold tracking-wider">Total Tugas</p>
        ...
        <Card class="border-none shadow-sm bg-white rounded-lg">
          <CardContent class="p-4 flex items-center gap-4">
            ...
            <div>
              <p class="text-xs text-gray-400 uppercase font-bold tracking-wider">Total Pertemuan</p>
        ...
        <Card class="border-none shadow-sm bg-white rounded-lg">
          <CardContent class="p-4 flex items-center gap-4">
            ...
            <div>
              <p class="text-xs text-gray-400 uppercase font-bold tracking-wider">Avg Kehadiran</p>
          ...
          <Table class="min-w-full">
            <TableHeader class="bg-gray-50">
              ...
              <TableRow class="bg-gray-50/50">
                ...
                <TableHead class="text-center font-semibold text-xs border-r w-16">%</TableHead>
                <!-- Presensi -->
                <TableHead class="text-center font-semibold text-xs border-r w-10">Hadis</TableHead>
                <TableHead class="text-center font-semibold text-xs border-r w-16">%</TableHead>
                <!-- UTS -->
