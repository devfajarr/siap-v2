...
const submitApprove = () => {
  ...
  form.post(route('v2.kaprodi.rekap-berita.approve', props.params), {
    preserveScroll: true,
    onSuccess: () => {
...
const isAllApprovedByKaprodi = computed(() => {
  return props.beritas.length > 0 && props.beritas.every(b => !!b.setuju_kaprodi)
})
    ...
    <div class="space-y-6">
      ...
      <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 no-print">
        <div class="flex items-center gap-2">
          <Link 
            :href="route('v2.kaprodi.rekap-berita.index')"
          ...
          <div>
            ...
            <p class="text-[#6B7280] text-sm">
              Kelola persetujuan berita acara perkuliahan tingkat program studi.
            </p>
          </div>
        </div>
      ...
      <Card class="border-none shadow-sm print-container bg-white">
        <CardContent class="p-8 sm:p-12 print-area">
          ...
          <!-- Tanda Tangan Verifikator (No Print unless specified, or visible on print) -->
          <div class="mt-8 grid grid-cols-2 text-center text-sm font-serif">
            ...
            <div>
              ...
              <p class="font-medium mb-16">Dosen Pengampu</p>
              <p class="underline font-bold">{{ beritas[0]?.dosen?.nama ?? '.....................................................' }}</p>
            </div>
          </div>
            ...
            <div class="space-y-1">
              ...
              <div class="flex flex-wrap gap-3">
                ...
                <div class="flex items-center gap-1.5 text-sm">
                  ...
                  <Badge :variant="beritas.every(b => !!b.setuju_wadir) ? 'success' : 'warning'">
                    {{ beritas.every(b => !!b.setuju_wadir) ? 'Disetujui' : 'Pending' }}
                  </Badge>
                </div>
              </div>
            </div>
