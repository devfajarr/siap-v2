...
<template>
  <AdminLayout>
    ...
    <Dialog :open="isAddModalOpen" @update:open="isAddModalOpen = $event">
      <DialogContent class="sm:max-w-[550px] p-0 overflow-hidden border-none shadow-2xl bg-white rounded-xl">
        <div class="bg-[#4B49AC] p-6 text-white relative">
          <DialogHeader>
            <DialogTitle class="text-xl font-bold text-white">Tambah Mata Kuliah</DialogTitle>
        ...
        <form @submit.prevent="submitAdd" class="p-6 space-y-6">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="grid grid-cols-2 gap-4">
              <div class="space-y-2">
                <Label class="text-xs font-bold text-gray-500 uppercase tracking-wider">SKS Teori</Label>
                <Input 
                  type="number" 
                  v-model="form.teori" 
                  class="h-11 border-gray-200 focus:border-[#4B49AC] focus:ring-[#4B49AC]/20 rounded-lg text-center font-bold" 
                />
              </div>
              <div class="space-y-2">
                <Label class="text-xs font-bold text-gray-500 uppercase tracking-wider">SKS Praktek</Label>
                <Input 
                  type="number" 
    ...
    <Dialog :open="isEditModalOpen" @update:open="isEditModalOpen = $event">
      <DialogContent class="sm:max-w-[550px] p-0 overflow-hidden border-none shadow-2xl bg-white rounded-xl">
        <div class="bg-[#4B49AC] p-6 text-white relative">
          <DialogHeader>
            <DialogTitle class="text-xl font-bold text-white">Edit Mata Kuliah</DialogTitle>
            <DialogDescription class="text-indigo-100 mt-1">
        ...
        <div class="p-6 text-center">
          ...
          <DialogHeader>
            ...
            <DialogDescription class="text-gray-500 text-center mt-2 px-4">
              Apakah Anda yakin ingin menghapus mata kuliah <span class="text-red-600 font-bold">"{{ selectedMatkul?.nama_matkul }}"</span>? 
              <br><span class="text-xs mt-2 block italic text-red-400 font-medium">Tindakan ini akan menghapus semua jadwal terkait secara permanen.</span>
            </DialogDescription>
          </DialogHeader>
