...
<template>
    <Head title="Pengelolaan KRS Mahasiswa" />
    ...
    <AdminLayout>
        <div class="space-y-6">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 class="text-3xl font-bold tracking-tight text-gray-900">Pengelolaan KRS Mahasiswa</h1>
                    <p class="text-muted-foreground mt-1">
                        Daftar kelas dikelompokkan per semester dan program studi untuk peninjauan dan cetak KRS.
                    </p>
                </div>
            ...
            >
                ...
                <p class="text-muted-foreground max-w-sm mb-8">
                    Belum ada data kelas aktif yang terdaftar di dalam sistem saat ini.
                </p>
            </div>
                        ...
                        <div class="flex items-stretch flex-wrap px-5 py-4 gap-y-4">
                            ...
                            >
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <!-- Cards semua jenis dalam prodi ini -->
                                    <div class="flex flex-wrap gap-3">
                                        ...
                                        >
                                            <Link
                                                ...
                                                :key="kelas.id"
                                                :href="route('v2.admin.krs.show', kelas.id)"
