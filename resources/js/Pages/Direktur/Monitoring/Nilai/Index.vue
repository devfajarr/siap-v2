  ...
  <AdminLayout>
    ...
    <div class="space-y-6">
      <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 class="text-2xl font-bold text-[#1F2937] font-nunito">Monitoring Nilai</h1>
          <p class="text-[#6B7280]">Pilih kelas untuk memantau rekapitulasi nilai akhir mahasiswa.</p>
        </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Link 
          ...
          :key="item.id"
          :href="route('v2.direktur.monitoring.nilai.detail', item.id)"
          class="group"
        >
